    ...
    18: function (t, e, i) {
      ...
      function s(t, e, i) {
        ...
        n.add(a),
          ...
          (this.createRenderTarget = function (i, n, o, s, r, a) {
            (i = i || t),
              (n = n || e),
            ...
            return new THREE.WebGLRenderTarget(i, n, {
              ...
              type: /(iPad|iPhone|iPod)/g.test(l)
                ? THREE.HalfFloatType
                : THREE.FloatType,
              stencilBuffer: !1,
            });
          ...
          ((d = function (e = {}) {
            ...
            (t.BirdGeometry = function (e) {
              ...
              for (c = 0; c < 3 * i; c++) {
                ...
                let p;
                (p = !d && f[u] ? f[u] : e.effect.getNewCol(o)),
                  d || f[u] || (f[u] = p),
                  (s.array[3 * c + 0] = p.r),
                  (s.array[3 * c + 1] = p.g),
                  (s.array[3 * c + 2] = p.b),
      ...
      class x extends n.b {
        ...
        initComputeRenderer() {
          ...
          w(t),
            ...
            (this.velocityUniforms.predator = { value: new r.Vector3() }),
            (this.velocityVariable.material.defines.BOUNDS = c.toFixed(2)),
            (this.velocityVariable.wrapS = r.RepeatWrapping),
            (this.velocityVariable.wrapT = r.RepeatWrapping),
            (this.positionVariable.wrapS = r.RepeatWrapping),
            (this.positionVariable.wrapT = r.RepeatWrapping);
        ...
        initGpgpuBirds() {
          ...
          this.birdUniforms = {
            color: { value: new r.Color(16720384) },
        ...
        getNewCol(t) {
          ...
          let a, l;
          if (
            ((l = -1 != e.colorMode.indexOf("Gradient") ? Math.random() : t),
        ...
        onInit() {
          (this.camera = new r.PerspectiveCamera(
            ...
            (this.fog = new r.Fog(16777215, 100, 1e3)),
          ...
          if (a)
            ...
            for (var s = 0; s < a; s++) {
              ((n = e[s] = new p(i)).position.x = 400 * Math.random() - 200),
              ...
              for (var l = 0; l < u.faces.length; l++)
                if (c)
                  ...
                  (u.faces[l].vertexColors[0] = t),
                    (u.faces[l].vertexColors[1] = t),
                    (u.faces[l].vertexColors[2] = t);
                }
              ((o = t[s] = new r.Mesh(
                u,
        ...
        onUpdate() {
          ...
          if ((t > 1 && (t = 1), (this.last = this.now), a))
        ...
        onMouseMove(t, e) {
          if (((this.mouseX = t - 0.5), (this.mouseY = e - 0.5), !a)) {
            const t = this.boids;
            let e;
            for (
              var i = new r.Vector3(
